...
import { FindUserForStrategyResponse } from '../../../api/src/app/modules/users/application/dtos/find-user-for-strategy-response.dto';
import { UserAudiences } from '../../domain/enums/user-audiences.enum';
import { InvalidUserAudienceException } from '../../domain/exceptions/invalid-user-audience.exception';
